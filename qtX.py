...
def mover(loc):
    state=os.system("move {0} mountdir/".format(loc))
    return state

def unmover(loc):
    state=os.system("move mountdir\{0} unlockdir/".format(loc))
    return state
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(90, 20, 450, 31))
        font = QtGui.QFont()
        ...
        text=os.popen("dir mountdir").read()
